                ...
                <div className=" details  gap-4 flex flex-col">
                  <div className=" flex flex-col w-[100%] gap-3">
                    <div className=" flex justify-between">
                        <h5 className="text-base lg:text-xl font-semibold text-[#333333]">Optic Big Breakfast Combo Menu</h5> 
                         <h5 className=" text-base lg:text-xl font-semibold text-primary1">32$</h5>
                    </div>
                    <div className=" flex flex-col gap-2">
                        <p className=" text-xs text-[#4F4F4F]">Chashew Chicken with Stir-Fry</p>
                   ...
                   <div className=" flex flex-col w-[100%] gap-3">
                    <div className=" flex justify-between">
                        <h5 className=" text-base lg:text-xl font-semibold text-primary1">Vegitables And Green Salad</h5> 
                         <h5 className="text-base lg:text-xl font-semibold text-primary1">32$</h5>
                    </div>
                    <div className=" flex flex-col gap-2">
                        <p className=" text-xs text-[#4F4F4F]">Spicy Vegan Potato Cury</p>
